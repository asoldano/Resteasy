...
public abstract class ResteasyClientBuilder extends ClientBuilder
{
    ...
    * @return an updated client builder instance
    */
   public abstract ResteasyClientBuilder defaultProxy(String hostname, int port, final String scheme);
   ...
   @Override
   public abstract ResteasyClientBuilder sslContext(final SSLContext sslContext);
   @Override
   public abstract ResteasyClientBuilder keyStore(final KeyStore keyStore, final char[] password);
   @Override
   public abstract ResteasyClientBuilder keyStore(final KeyStore keyStore, final String password);
   @Override
   public abstract ResteasyClientBuilder trustStore(final KeyStore trustStore);
   @Override
   public abstract ResteasyClientBuilder hostnameVerifier(final HostnameVerifier verifier);
   @Override
   public abstract ResteasyClientBuilder executorService(final ExecutorService executorService);
   @Override
   public abstract ResteasyClientBuilder scheduledExecutorService(final ScheduledExecutorService scheduledExecutorService);
   @Override
